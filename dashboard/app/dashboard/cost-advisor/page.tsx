...
export default function CostAdvisorPage() {
  ...
  const suggestions: Suggestion[] = useMemo(() => [
    ...
    { icon: <Gauge className="h-4 w-4" />, text: 'Which cloud resources are over-provisioned?' },
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <label className="min-w-0 flex-1">
                ...
                <textarea
                  ...
                  placeholder="Ask about the highest-cost VM, over-provisioned cloud resources, commitment gaps, or rollout plan..."

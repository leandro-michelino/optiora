...
- Advisor Conversation live smoke passing on the OCI VM: German prior chat history still returns English, and over-provisioning answers are scoped to real AWS/Azure/GCP/OCI resource rightsizing candidates rather than tenancy/account/imported/service aggregates.
